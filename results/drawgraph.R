d=read.table("compressed_size_versus_uncompressed_length-o4-t200-w0.csv",sep=";",header=TRUE)
...
e=read.table("compressed_size_hist-o4-t200-w0.csv",sep=";",header=TRUE)
